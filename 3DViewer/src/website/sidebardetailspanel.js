...
export class SidebarDetailsPanel extends SidebarPanel {
	...
	AddObject3DProperties(object3D) {
		...
		this.AddProperty(table, new Property(PropertyType.Number, 'X轴最大宽度', size.x));
		this.AddProperty(table, new Property(PropertyType.Number, 'Y轴最大宽度', size.y));
		this.AddProperty(table, new Property(PropertyType.Number, 'Z轴最大宽度', size.z));
