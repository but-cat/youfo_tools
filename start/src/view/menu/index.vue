<template>
	<div id="" class="app-menu w-full h-full overflow-auto">
		<div id="app-menu-content-wrapper">
			<div id="app-menu-content">
				<ContentHeader />

				<!-- <a id="youtube-link" class="clear-button" href="https://www.youtube.com/c/Hyperplexed" target="_blank"><i class="fa-brands fa-youtube" aria-hidden="true"></i><span>Hyperplexed</span></a> -->
				<WeatherSection />
...
import RestaurantsSection from './restaurantsSection.vue';
